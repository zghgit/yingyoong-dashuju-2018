<template>
    <div class="mtsl00005member">
      ...
      <el-table
        ...
        style
          ="width: 100%">
        <template v-for="(item,index) in MTSL_l00005_member">
...
<script>
  ...
  import {MTSL_l00005_member} from '../assets/js/MTSL_00005.js';
  import '../theme/threeCommon.less';
  import '../theme/fiveAppCommon.less';
    export default {
        name: "mtsl00005member",
        props: [],
        components: {},
        data() {
            return {
              ...
              dealitems:'',
              objData:[],
              MTSL_l00005_member: MTSL_l00005_member,
              //分页信息
              returnTotal: 0,
              returnN: 1,
              dataArrayAll: [],
      ...
      methods:{
        ...
        handleChangeTypesChange:function (val) {
          ...
          this.MTSL_l00005_member = [MTSL_l00005_member[0],MTSL_l00005_member[1],MTSL_l00005_member[2],MTSL_l00005_member[3],MTSL_l00005_member[6],MTSL_l00005_member[9],MTSL_l00005_member[12],];

          this.types.forEach((type,index)=>{
            val.forEach((t,ind)=>{
              if(t == type){
                MTSL_l00005_member.forEach((o,inde)=>{
                  if(o.flag == (index+1)){
                    this.MTSL_l00005_member.push(o)
                  }
                })
              }
            })
          ...
          //  排序
          this.MTSL_l00005_member.sort((o1,o2)=>{
        ...
        fnSundata:function () {
          ...
          const url = '/dw/mtsl/mtsl00005mem';
          fetch(url, {
            method: "POST",
        ...
        exportData() {
          ...
          let dp = '/dw/download/mtsl00005memexport?'
