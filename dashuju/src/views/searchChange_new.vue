        ...
        <Tabs type="card" :animated="false" v-model="scTabsValue">
          <Tab-pane label="账户交易营业部变更情况" name="scTabs1">
            ...
            <div style="padding-top:10px">
              <Page class="pageUtil" :total="returnTotal" :current="returnN" :page-size="500" :page-size-opts=[500,1000] show-sizer placement="top"  @on-page-size-change="tableChangeSize" @on-change="tableChange"></Page> </div>
          ...
          <Tab-pane label="账户指定交易变动情况" name="scTabs2">
            ...
            <div style="padding-top:10px">
              <Page class="pageUtil" :total="returnTotal2" :current="returnN2" :page-size="500" :page-size-opts=[500,1000] placement="top" show-sizer  @on-page-size-change="tableChangeSize2" @on-change="tableChange2"></Page> </div>
    ...
    methods: {
      ...
      exportData (type) {
        ...
        if (type === 1) {
          ...
          void(window.open('/dwapp/download/dwapp_downfile?reportType=TRADECHANGE&fileType=xlsx'+downfileParams));
        }
      },
    }
  }
