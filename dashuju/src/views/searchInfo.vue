            ...
            <Row :gutter="gutterValue">
                <Col :span="leftPane">
                    ...
                    <Card style="min-height:780px">
                        ...
                        <Modal id="lookInfoPop" title="成交明细及对手方信息查询  统计口径说明" v-model="changeInfo" class-name="vertical-center-modal" cancel-text>
                            <h3>数据说明</h3>
                      ...
                      <!--  <Table @on-sort-change="infoTableSort" id="infoTable" :context="self" :data="tableData1" :columns="tableColumns1"  ref="table" border stripe></Table> -->

                       <fastTable  @on-sort-change="infoTableSort" :width="2220" :bwidth="2200" :columns="tableColumns1" :data="tableData1"  ></fastTable>
