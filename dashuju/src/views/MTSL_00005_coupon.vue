<template>
    <div class="mtsl00005coupon">
      ...
      <el-table
        ...
        style
          ="width: 100%">
        <template v-for="(item,index) in MTSL_l00005_coupon">
          <el-table-column
...
<script>
  ...
  import {MTSL_l00005_coupon} from '../assets/js/MTSL_00005.js';
  import '../theme/threeCommon.less';
  import '../theme/fiveAppCommon.less';
    export default {
        name: "mtsl00005coupon",
        props: [],
        components: {},
        data() {
            return {
              ...
              MTSL_l00005_coupon: MTSL_l00005_coupon,
              //分页信息
              returnTotal: 0,
              returnN: 1,
              dataArrayAll: [],
      ...
      methods:{
        ...
        handleChangeTypesChange:function (val) {
          ...
          //   }
          // }
          this.MTSL_l00005_coupon =  [MTSL_l00005_coupon[0],MTSL_l00005_coupon[1],MTSL_l00005_coupon[2],MTSL_l00005_coupon[3],MTSL_l00005_coupon[6],MTSL_l00005_coupon[9],MTSL_l00005_coupon[12]];
          this.types.forEach((type,index)=>{
            val.forEach((t,ind)=>{
              if(t == type){
                MTSL_l00005_coupon.forEach((o,inde)=>{
                  if(o.flag == (index+1)){
                    this.MTSL_l00005_coupon.push(o)
                  }
                })
              }
            })
          ...
          //  排序
          this.MTSL_l00005_coupon.sort((o1,o2)=>{
        ...
        fnSundata:function () {
          ...
          const url = '/dw/mtsl/mtsl00005stock';
          fetch(url, {
            method: "POST",
        ...
        exportData() {
          ...
          var dp = '/dw/download/mtsl00005stockexport?'
