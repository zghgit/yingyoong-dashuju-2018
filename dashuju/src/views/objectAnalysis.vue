             ...
             <Row :gutter="gutterValue">
                ...
                <Modal id="lookInfoPop" title="可疑对象分析  统计口径说明" v-model="changeInfo" class-name="vertical-center-modal" cancel-text>
                    ...
                    <Tabs type="card" :animated="false" value='' v-model="tabsValue">
                      ...
                      <!--              <Table height="590" @on-sort-change="infoTableSort" id="qiTable1" :context="self" :data="qiTableData1" :columns="qiTableColumns1" size="small" ref="tableOneExport" border stripe></Table>
        ...
        <fastTable  :width="5690" :bwidth="5662" :columns="qiTableColumns5" :data="qiTableData5"  ></fastTable>
                ...
                <div style="padding-top:10px">
                           ...
                           <!--         <Table height="600" @on-sort-change="infoTableSort" id="qiTable6" :context="self" :data="qiTableData6" :columns="qiTableColumns6" size="small" ref="tableSixExport" border stripe></Table>
                                        <Page :total="returnTotal6" :current="returnN6" :page-size="20" show-elevator  @on-change="tableChange6"></Page>  -->
         ...
         <fastTable  :width="2340" :bwidth="2321" :columns="qiTableColumns6" :data="qiTableData6"  ></fastTable>
                ...
                <div style="padding-top:10px">
                         ...
                         <!--           <Table height="600" @on-sort-change="infoTableSort" id="qiTable7" :context="self" :data="qiTableData7" :columns="qiTableColumns7" size="small" ref="tableSevenExport" border stripe></Table>
                                        <Page :total="returnTotal7" :current="returnN7" :page-size="20" show-elevator show-total @on-change="tableChange7"></Page>  -->

         <fastTable  :width="2280" :bwidth="2261" :columns="qiTableColumns7" :data="qiTableData7"  ></fastTable>

                <div style="padding-top:10px">
                            <Page :total="returnTotal7" :current="returnN7" :page-size="200" :page-size-opts=[200,500,1000] placement="top" show-sizer  @on-page-size-change="tableChangeSize7" @on-change="tableChange7"></Page> </div>
                                      <div style="position:absolute; bottom:0px;right:3px; z-index:1;">
                           ...
                           <!--         <Table height="600" @on-sort-change="infoTableSort" id="qiTable8" :context="self" :data="qiTableData8" :columns="qiTableColumns8" size="small" ref="tableEightExport" border stripe></Table>
                                        <Page :total="returnTotal8" :current="returnN8" :page-size="20" show-elevator show-total @on-change="tableChange8"></Page> -->

                  <fastTable  :width="1923" :bwidth="1904" :columns="qiTableColumns8" :data="qiTableData8"  ></fastTable>

                <div style="padding-top:10px">
                            <Page :total="returnTotal8" :current="returnN8" :page-size="200" :page-size-opts=[200,500,1000] placement="top" show-sizer  @on-page-size-change="tableChangeSize8" @on-change="tableChange8"></Page> </div>
                                     <div style="position:absolute; bottom:0px;right:3px; z-index:1;">
                   ...
                   <ul class="list">
                      <li class="li-item" v-for="item in zqCodeList" @click="getTitleHandle(item.value)">{{item.label}}</li>
                        ...
                        <Form-item class="showrow" prop="showrow" id="AccountForm2">
                            在页面上显示前&nbsp;&nbsp;
                            <Input-number id="showrowInput" @on-change="validNum" :max="2000" :min="1" v-model="formValidate.showrow" size="small" style="width: 70px;"></Input-number>&nbsp;&nbsp;行
