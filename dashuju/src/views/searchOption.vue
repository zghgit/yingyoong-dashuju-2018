            ...
            <Row :gutter="gutterValue">
                <Col :span="leftPane">
                    ...
                    <Card style="min-height:780px">
                        ...
                        <!--<p id="infoTableList" class="redtext listlength">查询结果共&nbsp;{{dataLength}}&nbsp;条记录</p>-->
                        <p id="infoTableList" class="redtext listlength"></p>
                      <!--  <Table height="593" :columns="columns1" :data="data1" style="display:scroll-x" stripe></Table>
  -->

  <fastTable  :width="930" :bwidth="930" :addWidth="addWidth" :columns="columns1" :data="data1"  ></fastTable>
...
<div style="padding-top:10px">
                ...
                <Col :span="rightPane" class="infoRightCard">
                    <Card style="min-height:780px">
                        <!--<span id="hideInputBox" class="bluetext" @click="hideInput = !hideInput;(hideText == '隐藏输入条件')?hideText='显示输入条件':hideText='隐藏输入条件'" style="cursor:pointer;margin-bottom:10px;display: inline-block;">{{hideText}}</span>-->
                        <Form ref="formValidate" :model="formValidate" :rules="ruleValidate"  v-bind:class="{ hide: hideInput }">
                            <b>期权投资者账户</b>
                            ...
                            <Form-item class="showrow" prop="showrow" id="AccountForm2" >
                                在页面上显示前&nbsp;&nbsp;<Input-number id="showrowInput" :max="2000" :min="1" @on-change="validNum" v-model="formValidate.showrow" size="small" style="width: 70px;"></Input-number>&nbsp;&nbsp;行
