<template>
  <div class="mtsl00010month">
    ...
    <el-table
      ...
      style
        ="width: 100%">
      <template v-for="(item,index) in MTSL_00010_month">
        <el-table-column
...
<script>
  ...
  import {MTSL_00010_month} from '../assets/js/MTSL_00010.js';
  ...
  export default {
    ...
    data() {
      return {
        ...
        dealitems: 0,
        MTSL_00010_month: MTSL_00010_month,
        //分页信息
        returnTotal: 0,
        returnN: 1,
        dataArrayAll: [],
    ...
    methods: {
      ...
      fnSundata:function (pages,rows) {
        ...
        const url = '/dw/mtsl/mtsl00010mon';
        fetch(url, {
          method: "POST",
      ...
      exportData() {
        ...
        var dp = '/dw/download/mtsl00010monexport?'
