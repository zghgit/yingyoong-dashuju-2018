<template>
    <div class="mtsl00010year">
      ...
      <el-table
        ...
        style="width: 100%">
        <template v-for="(item,index) in MTSL_00010_year">
          <el-table-column
...
<script>
  ...
  import {MTSL_00010_year} from '../assets/js/MTSL_00010.js';
    ...
    export default {
        ...
        data() {
            return {
              ...
              dealitems:0,
              MTSL_00010_year: MTSL_00010_year,
              //分页信息
              returnTotal: 0,
              returnN: 1,
              dataArrayAll: [],
      ...
      methods: {
        ...
        fnSundata:function (pages,rows) {
          ...
          const url = '/dw/mtsl/mtsl00010year';
          fetch(url, {
            method: "POST",
        ...
        exportData() {
          ...
          setTimeout(function () {
            ...
            let dp = '/dw/download/mtsl00010yearexport?'
