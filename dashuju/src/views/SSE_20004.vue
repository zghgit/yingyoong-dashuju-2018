  ...
  export default {
    data() {
      return {
        ...
        tableData1: [
          // {sec_type_f: 'A股', sec_type_th: '首发合计', raise_count: '', raise_amt: ''},
          // {sec_type_f: 'A股', sec_type_th: '向公众增发', raise_count: '', raise_amt: ''},
          // {sec_type_f: 'A股', sec_type_th: '定向增发', raise_count: '', raise_amt: ''},
          // {sec_type_f: 'A股', sec_type_th: '配股', raise_count: '', raise_amt: ''},
          // {sec_type_f: 'A股', sec_type_th: '可转换债券转股', raise_count: '', raise_amt: ''},
          // {sec_type_f: 'A股', sec_type_th: '权证行权', raise_count: '', raise_amt: ''},
          // {sec_type_f: 'A股', sec_type_th: '再发合计', raise_count: '', raise_amt: ''},
          // {sec_type_f: 'A股', sec_type_th: '筹资合计', raise_count: '', raise_amt: ''},
          // {sec_type_f: 'B股', sec_type_th: '首发合计', raise_count: '', raise_amt: ''},
          // {sec_type_f: 'B股', sec_type_th: '再发合计', raise_count: '', raise_amt: ''},
          // {sec_type_f: 'B股', sec_type_th: '筹资合计', raise_count: '', raise_amt: ''},
          // {sec_type_f: '优先股', sec_type_th: '首发合计', raise_count: '', raise_amt: ''},
          // {sec_type_f: '优先股', sec_type_th: '再发合计', raise_count: '', raise_amt: ''},
          // {sec_type_f: '优先股', sec_type_th: '筹资合计', raise_count: '', raise_amt: ''},
          // {sec_type_f: '公司债', sec_type_th: '公司债', raise_count: '', raise_amt: ''},
          // {sec_type_f: '公司债', sec_type_th: '可转换债券', raise_count: '', raise_amt: ''},
          // {sec_type_f: '公司债', sec_type_th: '交换债', raise_count: '', raise_amt: ''},
          // {sec_type_f: '公司债', sec_type_th: '私募债', raise_count: '', raise_amt: ''},
          // {sec_type_f: '公司债', sec_type_th: '证券公司短债', raise_count: '', raise_amt: ''},
          // {sec_type_f: '公司债', sec_type_th: '可分离债券', raise_count: '', raise_amt: ''},
          // {sec_type_f: '公司债', sec_type_th: '公司债融资合计', raise_count: '', raise_amt: ''},
          // {sec_type_f: '市场合计', sec_type_th: '市场合计', raise_count: '', raise_amt: ''}
        ],
        //分页信息
        returnTotal: 0,
        returnN: 1,
    ...
    methods: {
      ...
      anchorClick: function (scope) {
        ...
        if(scope.row.sec_type_f == '公司债' || scope.row.sec_type_f == '可转换债券' || scope.row.sec_type_f == '交换债' || scope.row.sec_type_f == '私募债'|| scope.row.sec_type_f == '证券公司短债'||scope.row.sec_type_f == '可分离债券' || scope.row.sec_type_f =='公司债融资合计'){
          this.anchorTableColumn = anchorTableColumn.slice(0,anchorTableColumn.length - 1)
        }else{
          this.anchorTableColumn = anchorTableColumn
        }
        console.log(obj)
        ...
        $.ajax({
          ...
          success: function (res) {
            console.log('>>>>    ', res)
            if (res.success) {
              self.tableData2 = res.resData.data
