<template>
  <section class="bnd15001" id="fifteenCommon">
        ...
        <div slot="content"  >
          <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="100">
            <div class="flexBox">
             ...
             <el-col :span="6">
               <Form-item id="memCode" label="账户类型">
    ...
    <Modal id="lookInfoPop" title="A股账户数量统计(按持仓)  统计口径说明" v-model="changeInfo" class-name="vertical-center-modal"
           cancel-text>
      <br><b>数据说明</b>
      <br>数据时间范围：今年初至当前日期的前一交易日
      <br><b>指标说明</b>
      <br>账户类型：以账户代码的首字母分类
      <br>市值：只限沪市A股市值，基于每日闭市后持仓数据+大宗交易持仓调整
      <br><b>其他说明</b>
      <br>无
    ...
    <div class="tableBox">
      ...
      <el-table
        ...
        tooltip-effect="dark"
        style="width: 100%">
        <template  v-for="(item,index) in tableColumns_ACT02">
          <el-table-column
...
<script>
  ...
  import {tableColumns_ACT02} from '../assets/js/ACT_00002.js';
  ...
  export default {
    data() {
      return {
        ...
        changeInfo: false,
        //初始化表格信息
        tableColumns_ACT02: tableColumns_ACT02,
        tableDataACT02: [],
        //分页信息
        returnTotal: 0,
        returnN: 1,
    ...
    methods: {
      ...
      selectMemCodeHandle: function (item) {
        switch (item) {
          case 0 :
            ...
            break;
          case 1 :
            this.currentReportType = 'A';
            break;
          case 2 :
            this.currentReportType = 'B';
            break;
          case 3 :
            this.currentReportType = 'D';
            break;
          case 4 :
            this.currentReportType = 'F';
            break;
        }
      },
      /**
      ...
      handleSubmit(name,isPageClick) {
        this.$refs[name].validate((valid) => {
          ...
          //日期格式验证
          var r =  /([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9]{0-9}{3})([-/.]?)(((0[13578]|1[02])([-/.]?)(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)([-/.]?)(0[1-9]|[12][0-9]|30))|(02([-/.]?)(0[1-9]|[1][0-9]|2[0-9])))/
      ...
      //查询传送的参数
        ...
        this.searchParams = {
          ...
          'actType': this.quCurrentReportType,
          "pageSize": rows,
          "userId": srcUseridA,
          "userName": srcUsernameA,
          // "reQuery": statics,
          "pageNo": pages,
          "businessId": "ACT_00002",
        };
        //声明加载中
        $("#loadBox").removeClass("hide");
        //接口请求处理
        const url = '/dw/act/act00002';
        this.tableDataACT02 = [];
        this.dealitems = 0;
        let _this = this;
        _this.returnTotal = 0;
        ...
        this._fetch(fetch(url, {
          ...
          if (rtnStatic == false) {
            ...
            if (dataResponse.length == 0) {
              ...
              _this.tableDataACT02 = _this.dataArrayAll;
      ...
      exportData() {
        var downfileParams = "userId=" +
          srcUseridA + "&userName=" +
          srcUsernameA + "&signature=" +
          signatureA + "&Authorization=" +
          AuthorizationA +
          "&actType="+this.quCurrentReportType +
          "&tradeDate=" + this.quStartdate;
        $("#exportCurrent").attr("disabled");
