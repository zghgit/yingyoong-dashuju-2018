<template>
  <section class="constWidth" id="fifteenCommon">
    ...
    <Collapse id="dealPanel" class="dealPanel" v-model="collapse" >
      <Panel name="1" id="searchProfitCal">
        <p>账面盈利计算
        ...
        <div slot="content">
          <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
            <div>
              <Upload action="/base-service/api/decode_upfile?uploadType=ZHYL" :headers="upfileParams"
                      accept=".xls,.xlsx" :max-size="2048" :on-exceeded-size="handleMaxSize"
            ...
            <Form-item class="showrow" prop="showrow" id="AccountForm2">
              在页面上显示前&nbsp;&nbsp;<Input-number id="showrowInput" @on-change="validNum" :max="500" :min="1"
    ...
    <div class="containerBox">
      ...
      <div style="padding-top:10px" class="pageUtil">
    ...
    <!--</Modal>-->
    <!--<p id="infoTableList" class="redtext listlength"></p>-->
    <!--&lt;!&ndash;    <Table height="690" @on-sort-change="infoTableSort" id="infoTable" :context="self" :data="tableData1" :columns="tableColumns1" size="small" ref="table" border stripe></Table>-->
    <!--<Page :total="returnTotal" :current="returnN" :page-size="20" show-elevator show-total @on-change="tableChange"></Page> &ndash;&gt;-->
...
<style lang="less">
  #searchProfitCal #commissionRate > div{
