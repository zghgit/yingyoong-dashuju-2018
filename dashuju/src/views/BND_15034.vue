<template>
  <section class="constWidth" id="fifteenCommon">
    ...
    <Modal id="lookInfoPop" title="报价回购期末未到期余额  统计口径说明" v-model="changeInfo"
           class-name="vertical-center-modal"
           cancel-text>
      <h3>一．数据说明</h3>
      <p>
        本应用可查询出每个交易日债券质押式报价回购的期末未到期余额。
      </p>
      <h3>二．指标说明</h3>
      <p>
        1.本应用可查询自2009-5-25以来的数据。
        <br>2.期末回购未到期余额（亿元）：是指全部会员的债券质押式报价回购的所有品种（代码为205XXX）的T日的期末回购未到期余额加总，结果单位为亿元，四舍五入到2位小数。
      </p>
      <h3>三． 其他说明</h3>
      <p>
        无
    ...
    <!--<h2 class="infoTitle">报价回购期末未到期余额</h2>-->
    ...
    <!--<Modal id="lookInfoPop" title="报价回购期末未到期余额  统计口径说明" v-model="changeInfo" class-name="vertical-center-modal"-->
    <!--cancel-text>-->
    <!--<h3>数据说明</h3>-->
    <!--<p>本应用可查询出每个交易日债券质押式报价回购的期末未到期余额</p>-->
    <!--<h3>指标说明</h3>-->
    <!--<p>-->
    <!--1. 本应用可查询自2009-5-25以来的数据。<br>-->
    <!--2. 期末回购未到期余额（亿元）：是指全部会员的债券质押式报价回购的所有品种（代码为205XXX）的T日的期末回购未到期余额加总，结果单位为亿元，四舍五入到2位小数。<br>-->
    <!--</p>-->
    <!--<h3>其他说明</h3>-->
    <!--<p>-->
    <!--无-->
    ...
    <!--&lt;!&ndash;<fastTable :width="450" :bwidth="500" :columns="tableColumns1" :data="tableData1"></fastTable>&ndash;&gt;-->
    <!--<el-table-->
    <!--:data="tableData1"-->
    <!--border-->
    <!--style="width: 100%">-->
...
<script>
  ...
  import {tableColumns1} from '../assets/js/BND_15034.js';
  ...
  export default {
    ...
    methods: {
       ...
       */
      exportData(type) {
        var downfileParams = "row=1&type=bdsp_bnd15034&userId=" + srcUseridA + "&userName=" + srcUsernameA + "&signature=" + signatureA + "&Authorization=" + AuthorizationA + "&startDate=" + this.formValidate.startdate.format('yyyy-MM-dd') +
          "&endDate=" + this.formValidate.enddate.format('yyyy-MM-dd');
          ...
          void(window.open('/dw/download/bndexcel?' + downfileParams + commonGetReqParam));
