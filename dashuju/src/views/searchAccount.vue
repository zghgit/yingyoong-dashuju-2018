<template>
  <section class="constWidth">
    <!--头部logo-->
    <header></header>
    <h2 class="infoTitle">一码通关联账户查询</h2>
    <div class="mainBox changeBox">
      <Row :gutter="gutterValue">
        ...
        <Card class="iviewCard">
          ...
          <Modal id="lookInfoPop" title="一码通关联账户查询  统计口径说明" v-model="changeInfo" class-name="vertical-center-modal"
                 cancel-text>
            <h3>数据说明</h3>
            <p>无</p>
            <h3>指标说明</h3>
        ...
        <Card class="iviewCard">
          <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
            <b>查询类别</b>
            <Select v-model="modelSel" :label-in-value="true" class="selectWidth" @on-change="thisChange">
