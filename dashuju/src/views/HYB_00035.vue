...
<template>
  <section class="constWidth" id="hyb00035">
    <div id="fifteenCommon">
      ...
      <Modal id="lookInfoPop" title="约定购回及股票质押履约保障比例(四)  统计口径说明" v-model="changeInfo" class-name="vertical-center-modal"
             cancel-text>
        1．有约定购回未到期或股票质押未到期的融出方账户所属的证券公司才予以展示。统计时，仅统计融出方账户的账户类型为“ZY”（表示“自营出资”）的数据
...
<script>
  ...
  import {tableColumns1} from '../assets/js/HYB_00035.js';
  ...
  export default {
    ...
    methods: {
      ...
      exportData() {
        ...
        var dp = '/dw/download/hyb00035Export?'
