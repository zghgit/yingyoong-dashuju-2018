...
<div id="gdh00011">
    ...
    <Modal id="lookInfoPop" title="股票质押回购待购回统计  统计口径说明" v-model="changeInfo"
      ...
      <h3>二．指标说明</h3>
      <p>
        1．标的证券市值=证券数量 * 收盘价，债券使用全价计算
        <br>2．履约保证比例(%) = 标的证券市值/初始交易金额，其中标的证券市值为标的证券数量在查询指定日期的收盘市值，对于标的证券类型为债券时，收盘价需使用全价=行情中收盘净价+当日应计利息
      </p>
      <h3>三． 其他说明</h3>
      <p>
        1．按融入方账户进行汇总
        ...
        <br>4．通常情况下，在T日20:00起可访问应用获得T日正确统计数据
        <br>5．会员上报的字段，只能访问T-2日及之前的数据
      </p>
    </Modal>
    ...
    <!--头部logo-->
    <!--<header></header>-->
    <!--<h2 class="infoTitle">股票质押回购待购回统计</h2>-->
    <!--<div class="mainBox changeBox" id="gdh00011">-->
      <!--<Row :gutter="gutterValue">-->
        ...
        <!--<Card class="iviewCard">-->
          ...
          <!--<Modal id="lookInfoPop" title="股票质押回购待购回统计  统计口径说明" v-model="changeInfo" class-name="vertical-center-modal"-->
                 <!--cancel-text>-->
            <!--<h3>数据说明</h3>-->
            <!--<p>只包含股票质押未到期的数据</p>-->
            <!--<h3>指标说明</h3>-->
            <!--<p>-->
              <!--1． 标的证券市值=证券数量 * 收盘价，债券使用全价计算<br>-->
              <!--2． 履约保证比例(%) = 标的证券市值/初始交易金额，其中标的证券市值为标的证券数量在查询指定日期的收盘市值，对于标的证券类型为债券时，收盘价需使用全价=行情中收盘净价+当日应计利息<br>-->
            <!--</p>-->
            <!--<h3>其他说明</h3>-->
            <!--<p>-->
              <!--1． 按融入方账户进行汇总<br>-->
              <!--2． 排序方式为：融入方账户（正序从小到大<br>-->
              <!--3． 有待购回数据的账户才展示，否则不予展示<br>-->
              <!--4． 通常情况下，在T日20:00起可访问应用获得T日正确统计数据<br>-->
              <!--5． 会员上报的字段，只能访问T-2日及之前的数据<br>-->
            <!--</p>-->
          <!--</Modal>-->
          <!--&lt;!&ndash;头部logo&ndash;&gt;-->
          <!--<p id="infoTableList" class="redtext listlength"></p>-->
        ...
        <!--<Card class="iviewCard">-->
          <!--<Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">-->
            ...
            <!--&lt;!&ndash;<Form-item class="showrow">&ndash;&gt;-->
              <!--&lt;!&ndash;<p><label class="redtext fontsize12">{{new Date(formValidate.startdate).format('yyyy-MM-dd')}}</label></p>&ndash;&gt;-->
...
<script>
  ...
  import {tableColumns1} from '../assets/js/GDH_00011.js';
  ...
  export default {
    ...
    mounted() {
      console.warn(formatTbousandth(50000));
    ...
    methods: {
      ...
      formatData (row, column, cellValue) {
        ...
        if (prop == 'hold_vol_sum' || prop == 'trade_amt_sum' || prop == 'hold_amt_sum' || prop == 'impawn_vol_amt' || prop == 'pay_amt_all_s' || prop == 'other_vol') {
...
<style lang="less">
  #gdh00011 .el-table__body-wrapper tr:nth-last-child(1) {
    display: none;
  }
